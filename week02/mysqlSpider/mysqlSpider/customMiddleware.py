...
class CustomerUserAgent(HttpProxyMiddleware):
    def __init__(self,crawler, auth_encoding='utf-8', proxy_list = None):
    ...
    def from_crawler(cls,crawler):
        ...
        return cls(crawler,auth_encoding,http_proxy_list)
